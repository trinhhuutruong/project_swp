<%-- 
    Document   : forgetPwd
    Created on : May 28, 2022, 3:29:58 PM
    Author     : Admin
--%>
                ...
                <div class="card card-4">
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            <div>
                                <div class="" style="text-align: center" ><h2 >Thông Tin</h2></div>
                            ...
                            <div class="row row-space">
                                ...
                                <div class="p-t-15"  style="text-align: center">
                                    <button class="btn btn--radius-2 btn--blue" name="action" value="Confirm" type="submit">Tiếp tục</button>
                                </div>
                            </div>    
                        </form>
                    </div>
